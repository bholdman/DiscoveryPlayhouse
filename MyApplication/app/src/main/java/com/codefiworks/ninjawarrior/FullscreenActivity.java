package com.codefiworks.ninjawarrior;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgIntro.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                ...
                ViewGroup container = (ViewGroup) layoutInflater.inflate(R.layout.video,null);

                popupWindow = new PopupWindow(container,400,400,true);
                popupWindow.showAtLocation(relativeLayout,Gravity.NO_GRAVITY,0,0);

                VideoView videoview = (VideoView) container.findViewById(R.id.vidIntro);
